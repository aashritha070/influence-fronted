...
{isCoverPic?  (
   <img className="thumbNail" src={cover + post.coverPic} alt=""/>
    ...
    <img  className="thumbNail" src='https://upload.wikimedia.org/wikipedia/commons/thumb/6/65/No-Image-Placeholder.svg/1665px-No-Image-Placeholder.svg.png' alt=''></img>
   )
