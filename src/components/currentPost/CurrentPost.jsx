...
export default function CurrentPost() {
  ...
  const cover = "http://localhost:5000/coverPic/"
  ...
  return (
    <div className="currentPost">
      <div className="currentViewPost">
        {
          post.coverPic!== "" ? (
            <img src={cover + post.coverPic}
              alt="none"
              className="viewingImg"></img>
              ):(
                <img  className='viewingImg' src='https://upload.wikimedia.org/wikipedia/commons/thumb/6/65/No-Image-Placeholder.svg/1665px-No-Image-Placeholder.svg.png' alt='none'></img>
              )
}
