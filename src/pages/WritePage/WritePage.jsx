...
export default function WritePost() {
  ...
  const handleSubmit = async (e) => {
   ...
   await axios.post('http://localhost:5000/posts/', blog).then((res)=>{
   console.log("hihih") 
   successToast();
      ...
      <i className='fa-solid fa-image'></i>
        ...
        <div className="selectTags">
          <select className='dropdown_box'
            ...
            onChange={(e) => {
              ...
              const latestTags = tags.filter((tag) => tag.name !== selectedTag);
              setTags(latestTags);
            }}
          >
        ...
        <div className='selectedTags'>
          ...
          {selectedTags.map((tag) => (
            <span className='tagsSelected' style={{ color: 'black' }} key={tag}>
              {tag}{' '}
